...
public partial class StoreMaterials : MonoBehaviour {
    ...
    private void Awake() {
        OnEnable();
        // Make sure to use a unique material instance
        if(Application.isPlaying && !LevelSerializer.IsDeserializing) {
        ...
        foreach (var p in list) {
            ...
            switch (p.type) {
                ...
                case MaterialProperty.PropertyType.TexEnv:
                    ...
                    o.value[0] = SerializeAssetReference.instance.Save(m.GetTexture(p.name));
        ...
        foreach (var v in values) {
            switch (v.property.type) {
                ...
                case MaterialProperty.PropertyType.Range:
                    ...
                    break;
                case MaterialProperty.PropertyType.TexEnv:
                    m.SetTexture(v.property.name, (Texture)SerializeAssetReference.instance.Load((object[])v.value[0], this));
